...
contract Peer2PeerProjectDashBoard{
    ...
    function createProject(string memory _task_des, uint _reward,int _minCredit, string memory _duration) public returns(address){
        address newProject=new Peer2PeerProject(msg.sender,_task_des, _reward, _minCredit,   _duration);
...
contract Peer2PeerProject{
    ...
    constructor (address _hirer, string memory _task_des, uint _reward,int _minCredit, string memory _duration) public{
